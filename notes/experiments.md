...
commands = []
models = ["polynomial_nn", "ccp", "ffnn"]

polynomial = "lambda a: a"
polynomial_name = "a"
...
polynomial = "lambda a, b, c, d: 2*(a**2)*(b**2)*c**2 - 3*d"
...
commands = []
models = ["ccp", "polynomial_nn", "pdc", "pdclow"]
noise = [False, True]
change_std = [False, True]

polynomial = "lambda a, b, c, d: 2*(a**2)*(b**2)*c**2 - 3*d"
polynomial_name = "2a2_b2_c2-3d"
n_degree = 10
epochs = 50
...
polynomial = "lambda a, b, c, d: 2*(a**3)*(b**2)*(c**2) - (d**6)"
polynomial_name = "2a3_b2_c2-d6"
n_degree = 7
epochs = 100
...
polynomial = "lambda a, b, c, d, e: (a**3)*(b**2)*(c**3) - d**3*e**3"
polynomial_name = "a3_b2_c3-d3_e3"
n_degree = 8
epochs = 100
...
polynomial = "lambda a, b, c, d, e, f: 2*(a**3)*(b**2)*(c**2)*(d**3) - (e**5)*(f**5)"
polynomial_name = "2a3_b2_c2_d3-e5_f5"
n_degree = 10
epochs = 50
